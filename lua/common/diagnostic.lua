local formatters = {
    ...
    isort = {command = 'isort', args = {'--quiet', '-'}, rootPatterns = {'pyproject.toml', '.isort.cfg'}},
    ...
    shfmt = {command = 'shfmt', args = {'-filename', '%filepath'}, rootPatterns = {'.editorconfig'}},

    stylua = {command = 'stylua', args = {'-'}, rootPatterns = {'stylua.toml'}, requiredFiles = {'stylua.toml'}}
}
...
local M = {formatters = formatters, filetypes = filetypes, linters = linters}
